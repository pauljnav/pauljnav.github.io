...
- [PowerShell : How-To](https://learn.microsoft.com/en-us/powershell/scripting/samples/sample-scripts-for-administration) - Sample scenarios for administering with PowerShell

- [GitHub](https://github.com) - Code hosting and version control
- [PowerShell Gallery](https://powershellgallery.com) - Central repository for PowerShell content
...
### Discords and such
- [PDQ Discord - powershell-scripting](https://discordapp.com/channels/694656089517457419/1096088368430985298)
- [PowerShell Discord - powershell-help-forum](https://aka.ms/psdiscord)

### Resources & Inspiration

- [Agent Skills](https://agentskills.io/home) - A standardized way to give AI agents new capabilities and expertise
- [First Contributions](https://firstcontributions.github.io/) - Help beginner open source contributors
- [First-Time-Issue](https://github.com/PowerShell/PowerShell/issues?q=state:open%20label:First-Time-Issue) - Easy issues first time contributors can work on to learn about the PowerShell project
- [Hacker News](https://news.ycombinator.com) - Tech news and discussion
- [NVIDIA AI Podcast](https://ai-podcast.nvidia.com/) - Real stories, real impact
...
- [PR for Leap Year](https://github.com/mikefrobbins/PowerShell/blob/main/MrToolkit/Public/Get-MrLeapYear.ps1) - Get-MrLeapYear.ps1 script on GitHub
